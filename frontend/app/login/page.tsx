...
const Login = () => {
    return (
        <div className='w-full h-screen flex flex-col items-center justify-center text-black bg-white bg-[radial-gradient(#2b2b2b_1px,transparent_1px)] [background-size:35px_35px]'>
            ...
            <button className="mt-3 cursor-pointer px-4 py-2 flex flex-row items-center gap-2 bg-white text-black border border-black hover:bg-black hover:text-white duration-200 transition-colors">
